            ...
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border px-4 py-2 cursor-pointer" onClick={handleSortByDate}>
                  Created At {sortOrder === "asc" ? <FaSortUp /> : <FaSortDown />}
                </th>
      ...
      {selectedTicket && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg w-96 shadow-lg">
            ...
            <p className='my-2'><strong>Subject:</strong> {selectedTicket.subject}</p>
            <p className="font-bold my-1">Description:</p>
            <div className="p-4 border rounded bg-gray-100">{selectedTicket.description}</div>
